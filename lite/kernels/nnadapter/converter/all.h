...
REGISTER_CONVERTER(
    cast,
    ConvertCast,
    "huawei_ascend_npu,cambricon_mlu,huawei_kirin_npu,nvidia_tensorrt,intel_openvino");
...
REGISTER_CONVERTER(
    arg_max,
    ConvertArgMinMax,
    "huawei_ascend_npu,huawei_kirin_npu,nvidia_tensorrt,cambricon_mlu,intel_openvino");
