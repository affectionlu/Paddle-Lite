...
REGISTER_CONVERTER(
    gelu,
    ConvertGelu,
    "huawei_ascend_npu,huawei_kirin_npu,kunlunxin_xtcl,cambricon_mlu,intel_openvino");
...
REGISTER_CONVERTER(
    hard_swish,
    ConvertHardSwish,
    "huawei_ascend_npu,huawei_kirin_npu,verisilicon_timvx,nvidia_tensorrt,intel_openvino");
REGISTER_CONVERTER(
    arg_max,
    ConvertArgMinMax,
...
REGISTER_CONVERTER(flatten,
                   ...
                   "rockchip_npu,mediatek_apu,huawei_kirin_npu,huawei_ascend_"
                   "npu,amlogic_npu,verisilicon_timvx,kunlunxin_xtcl,cambricon_"
                   "mlu,android_nnapi,intel_openvino");
